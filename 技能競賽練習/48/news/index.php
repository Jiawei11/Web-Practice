...
<body>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td><?php echo $row[$row2['col1']]; ?></td>
                <td><?php echo $row[$row2['col2']]; ?></td>
                <td><?php echo $row[$row2['col3']]; ?></td>
                <td><?php echo $row[$row2['col4']]; ?></td>
                <td><?php echo $row[$row2['col5']]; ?></td>
                <td><?php echo $row[$row2['col6']]; ?></td>
            </tr>
        </tbody>
        <?php
            }
